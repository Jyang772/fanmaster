...
QT_MOC_LITERAL(3, 20, 11)
    ...
    "Controller\0setText\0\0std::string\0"
};
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setText((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Controller::*_t)(std::string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controller::setText)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Controller::setText(std::string _t1)
{
